...
Миграции базы данных необходимы для создания и обновления структуры базы данных.

1. Убедитесь, что виртуальное окружение активировано (если используете локальную установку).
...
2. Примените миграции:
   ...
   Эта команда создаст все необходимые таблицы в базе данных на основе моделей Django.
...
3. При первом запуске примените миграции внутри контейнера:
